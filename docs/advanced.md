...
Full command reference, config schema, manual rollback, and how it all works under the hood. For the pitch and quick start, see the [main README](../README.md).
